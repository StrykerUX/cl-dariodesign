          ...
          {services.map((service, index) => (
            ...
            >
              <div className={`${index % 2 === 0 ? 'md:order-1' : 'md:order-2'} order-1`}>
                <DepthEffect type="image" parallaxSpeed={0.3 + index * 0.1}>
                  <Placeholder 
                    label={service.image}
                    ratio="16/9"
              ...
              <div className={`${index % 2 === 0 ? 'md:order-2' : 'md:order-1'} order-2 space-y-3 md:space-y-4`}>
                <DepthEffect type="heading" parallaxSpeed={0.15 + index * 0.05}>
                  <h3 className="text-lg md:text-xl font-semibold text-text-primary">
                    {service.title}
                  </h3>
                </DepthEffect>
                <DepthEffect type="text" parallaxSpeed={0.25 + index * 0.05}>
